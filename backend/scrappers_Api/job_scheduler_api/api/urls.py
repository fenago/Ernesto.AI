...
from api.views import ExecuteScrapper, CancelScrapper, ListScrapperDetails, ScrapperStatus, ListScrapperStatus
...
urlpatterns = [
    ...
    path('scrappers_statuses/',ListScrapperStatus.as_view(), name = 'scrappers-statuses')]